...
def parse_options(is_train=True):
    ...
    parser.add_argument(
        '-opt', type=str, help='Path to option YAML file.', default='/Users/Cody/Documents/Classes/cs670/Project/project_github_repo/denoising/NAFNet/options/test/SIDD/NAFNet-width64.yml')
    parser.add_argument(
        '--launcher',
